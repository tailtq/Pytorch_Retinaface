...
class MetadataPopulatorForImageClassifier(object):
  ...
  def _create_metadata(self):
    ...
    output_confidence_meta.content.contentPropertiesType = (_metadata_fb.ContentProperties.FeatureProperties)
    output_confidence_meta.content.contentProperties = (_metadata_fb.FeaturePropertiesT())
    ...
    output_landmark_meta.content.contentPropertiesType = (_metadata_fb.ContentProperties.FeatureProperties)
    output_landmark_meta.content.contentProperties = (_metadata_fb.FeaturePropertiesT())
    ...
    subgraph.outputTensorMetadata = [output_location_meta, output_confidence_meta, output_landmark_meta]
